...
import { ArrowUpRight, Brain, Buildings, GithubLogo, ShieldCheck } from "@phosphor-icons/react";
...
export function ProjectCard({ project, featured = false }: { project: Project; featured?: boolean }) {
  ...
  return (
    <motion.article className={`project-card ${featured ? "project-card--featured" : ""}`} initial={{ opacity: 0, y: 28 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, margin: "-100px" }} transition={{ duration: 0.55 }} whileHover={{ y: -6 }}>
      ...
      <div className="project-actions">
        <a href="#contact">View case study <ArrowUpRight size={15}/></a>
        <a href="https://github.com/Anmol-Malviya" target="_blank" rel="noreferrer"><GithubLogo size={15}/> Repository</a>
      </div>
    </motion.article>
  );
}
